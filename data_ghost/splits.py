...
# _SPLITS['bdd100k_val']['test'] = {'seq': os.listdir('/home/share/workspace/datasets/BDD100/bdd100k/images/track/val'), 'dir': 'val'}
# _SPLITS['bdd100k_test']['test'] = {'seq': os.listdir('/home/share/workspace/datasets/BDD100/bdd100k/images/track/test'), 'dir': 'test'}
...
_SPLITS['dance_test']['test'] = {'seq': os.listdir('/home/share/workspace/datasets/dancetrack/test'), 'dir': 'test'}
_SPLITS['dance_val']['test'] = {'seq': os.listdir('/home/share/workspace/datasets/dancetrack/val'), 'dir': 'val'}
